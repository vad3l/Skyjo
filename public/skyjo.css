...
.dark #room #load p, .dark #room #endParty p{
	color: white !important;
}
...
.dark #room #content main, .dark #room #content aside{
...
#btnLancerPartie:hover, #btnRelancerPartie:hover, #btnLogout:hover {
	cursor:pointer;
	box-shadow: 5px 5px 10px rgba(0, 0, 0, 0.3);
    transform: scale(1.05); 
} 
